<?php
    class client{
        ...
        public function add_ddb(){
            ...
            $ddb = new ddb();
            $ddb->insert("INSERT INTO clients (nom, prenom, age, email) VALUES (?,?,?,?)", array($this->getNom(), $this->getPrenom(), $this->getAge() ,$this->getEmail()));
        ...
        public function update_ddb(){
            ...
            $ddb = new ddb();
            $ddb->update("UPDATE clients SET nom = ?, prenom = ?, age = ? , email = ? WHERE id_client = ?", array($this->getNom(), $this->getPrenom(), $this->getAge() ,$this->getEmail(), $this->getIdClient()));
            header("location:index.php");
            exit();
        }
        ...
        public function delete_ddb(){
            ...
            $ddb = new ddb();
            $ddb->delete("DELETE FROM clients WHERE id_client = ? ", array($this->getIdClient()));
            header("location:index.php");
            exit();
        }
